...
import { Kategori, PageProps, Supplier } from '@/types';
...
interface CreateBarangProps extends PageProps {
    kategori: Kategori[];
    supplier: Supplier[];
}
...
function CreateBarang() {
    // hooks
    const { kategori, supplier } = usePage<CreateBarangProps>().props;
    ...
    return (
        <AuthLayout
            title="Tambah Barang"
            subtitle="Halaman ini digunakan untuk tambah barang."
        >
