...
import { PageProps, Permission, Roles, User } from '@/types';
...
function EditUser() {
    // hooks
    const { user, permissions, roles } = usePage<EditUserProps>().props;
    ...
    return (
        <AuthLayout
            title="Edit User"
            subtitle="Halaman ini digunakan untuk edit user."
        >
